...
export function startupServiceFactory(appInit: AppInitService) : Function {   //A function passing in the factory for the init service. Causes the get settings to execute
